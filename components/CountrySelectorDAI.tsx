        ...
        <div className="w-full flex flex-col p-6 space-y-8 justify-center items-start md:flex-row md:space-y-0 md:space-x-5 md:py-10 md:pl-10 md:px-10 relative">
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Argentina">
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Bulgaria">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Bulgaria
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Colombia">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Colombia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/France">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    France
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Greece">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Greece
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Indonesia">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Indonesia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Latvia">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Latvia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Mexico">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Mexico
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/South-Africa">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    South Africa
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Turkey">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Turkey
                  </p>
                </Link>
          ...
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Australia">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Australia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Cameroon">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Cameroon
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Ecuador">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Ecuador
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Germany">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Germany
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Hong-Kong">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Hong Kong
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Italy">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Italy
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Lebanon">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Lebanon
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Nigeria">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Nigeria
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Philippines">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Philippines
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Spain">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Spain
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Uruguay">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Uruguay
                  </p>
                </Link>
          ...
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Brazil">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Brazil
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/China">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    China
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Egypt">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Egypt
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Ghana">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Ghana
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/India">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    India
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Kenya">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Kenya
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Malaysia">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Malaysia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Pakistan">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Pakistan
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Romania">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Romania
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Thailand">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Thailand
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Venezuela">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Venezuela
                  </p>
                </Link>
