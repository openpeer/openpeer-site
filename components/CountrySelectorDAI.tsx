        ...
        <div className="w-full flex flex-col p-6 space-y-8 justify-center items-start md:flex-row md:space-y-0 md:space-x-5 md:py-10 md:pl-10 md:px-10 relative">
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Argentina" target="_blank">
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Bulgaria" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Bulgaria
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Colombia" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Colombia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/France" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    France
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Greece" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Greece
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Indonesia" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Indonesia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Latvia" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Latvia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Mexico" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Mexico
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Peru" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Peru
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/South-Africa" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    South Africa
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Turkey" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Turkey
                  </p>
                </Link>
          ...
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Australia" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Australia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Cameroon" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Cameroon
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Ecuador" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Ecuador
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Germany" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Germany
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Hong-Kong" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Hong Kong
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Italy" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Italy
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Lebanon" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Lebanon
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Nigeria" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Nigeria
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Philippines" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Philippines
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Spain" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Spain
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Uruguay" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Uruguay
                  </p>
                </Link>
          ...
          <div className="w-full md:w-1/3 flex flex-col space-y-8 items-left justify-center">
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Brazil" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Brazil
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/China" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    China
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Egypt" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Egypt
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Ghana" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Ghana
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/India" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    India
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Kenya" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Kenya
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Malaysia" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Malaysia
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Pakistan" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Pakistan
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Romania" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Romania
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Thailand" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Thailand
                  </p>
                </Link>
            ...
            <div className="flex items-center">
              ...
              <div className="custom-min-w">
                <Link href="/how-to-buy-dai/Venezuela" target="_blank">
                  <p className="text-white text-3xl text-normal text-left mt-2 mr-2">
                    Venezuela
                  </p>
                </Link>
