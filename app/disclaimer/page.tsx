		...
		<>
			...
			<div className="mx-auto py-16 px-4 w-full md:w-2/3 text-gray-800">
				<h2 className="text-2xl font-bold py-4">
					OPENPEER PROTOCOL DISCLAIMER
				</h2>
				<span className="text-gray-400">Last modified: 14 April 2023</span>

				<p className="mt-16 mb-4" />
				<p className="mb-4">
					OpenPeer is a decentralized self custody peer to peer protocol on the
					Ethereum Blockchain which allows users to trade crypto and fiat
					between each other. There is currently one version of the OpenPeer
					...
					deployed on the Ethereum Blockchain and which may be deployed on
					various other blockchains as determined appropriate. Your use of the
					OpenPeer Protocol may involve various risks, including, but not
					limited to, losses while digital assets are being supplied to the
					OpenPeer Protocol and smart contract vulnerabilities. Before using the
					OpenPeer Protocol, you should review the relevant documentation to
					make sure you understand how the OpenPeer Protocol works, including
					...
					access the OpenPeer Protocol through dozens of web or mobile
				...
				<p className="mb-4">
					AS DESCRIBED IN THE OPENPEER PROTOCOL TERMS OF SERVICE AGREEMENT, THE
					OPENPEER PROTOCOL IS PROVIDED "AS IS", AT YOUR OWN RISK, AND WITHOUT
					WARRANTIES OF ANY KIND. Although OpenPeer Labs Inc. a corporate entity
					domiciled in Panama and d/b/a/ “OpenPeer Protocol” (“OpenPeer
					Protocol”) developed much of the initial code for the OpenPeer
					Protocol, it does not provide, own, or control the OpenPeer Protocol,
					which is run by smart contracts deployed on the Ethereum blockchain
					and is facilitated and maintained by the OpenPeer Protocol DAO (the
					...
					OpenPeer Protocol will be liable for any claims or damages whatsoever
					associated with your use, inability to use, or your interaction with
					other users of, the OpenPeer Protocol, including any direct, indirect,
					...
					arising out of any interaction with the OpenPeer Protocol or the
					associated DAO, Organisation or d/b/a entity.
				</p>

				<p className="mb-4">
					OPENPEER PROTOCOL RESERVES THE RIGHT TO MODIFY THIS DISCLAIMER AND
					...
					POSTED, AND YOUR CONTINUED USE OF THE OPENPEER PROTOCOL INTERFACE WILL
